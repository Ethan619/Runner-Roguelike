...
/// <summary>
/// A Collection of extension/utility methods for Unity's Collider2D types
/// </summary>
	...
	*/
	public static Collider2D Clone(this Collider2D col){
		...
		if(col as PolygonCollider2D != null){
			...
			throw new System.Exception(col.GetType().ToString() + " is not supported by the Clone method.");
		}
		if(clone != null){
